...
"""
    ...
    def recommand_question(self) -> str:
        ...
        return response.text.strip()
# Initialize the bot
dermatologist_bot = DermatologistBot()

# Test the generate_response method with a sample prompt
prompt = "I have a red, itchy rash on my arm that has been there for a week. What could it be?"
response = dermatologist_bot.generate_response(prompt)
